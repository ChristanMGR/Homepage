...
from .views import PostList, PostSingle, PostCreate, PostSingleDel, PostSingleUpdate, ProjectList, ProjectSingleDel, ProjectSingleUpdate, ProjectCreate, FeedbackList, FeedbackCreate, FeedbackSingleDel, FeedbackSingleUpdate 
